...
export const META_AUGMENTS = [
  ...
  { name:'N.O.V.A. 프로토콜', tier:'S' as Tier, avgPlace:3.8, pickRate:12.4 },
  { name:'도전자의 기세', tier:'A' as Tier, avgPlace:4.0, pickRate:19.7 },
  { name:'정령의 가호', tier:'A' as Tier, avgPlace:4.2, pickRate:10.3 },
  { name:'암흑의 인장', tier:'A' as Tier, avgPlace:4.3, pickRate:8.9 },
  { name:'재구름의 행운', tier:'B' as Tier, avgPlace:4.6, pickRate:22.1 },
  { name:'안정된 재정', tier:'B' as Tier, avgPlace:4.8, pickRate:18.5 },
  { name:'절박한 도박', tier:'C' as Tier, avgPlace:5.2, pickRate:11.8 },
];
